...
import py.com.ideasweb.perseo.ui.activities.SplashActivity;

import static py.com.ideasweb.perseo.ui.activities.MainActivity.JOB_STATE_CHANGED;
import static py.com.ideasweb.perseo.ui.activities.MainActivity.LOCATION_ACQUIRED;
...
//                            startService(i1); //i have disabled the call as the server URL in intent service is dummy URL. Change the URL to your server URL and call this intent service
        ...
        getSharedPreferences("PERSEO",MODE_PRIVATE).edit().putBoolean("isServiceStarted",true).apply();
    ...
    private void createNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notification = mBuilder.setSmallIcon((Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)? R.mipmap.ic_launcher:R.mipmap.ic_launcher).setTicker("Tracking").setWhen(0)
                    .setAutoCancel(false)
                    .setCategory(Notification.EXTRA_BIG_TEXT)
                    .setContentTitle("Tracking")

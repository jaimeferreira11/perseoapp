...
public class Facturadetlog extends LitePalSupport {
    ...
    public int getFacturacablog_id() {
        return facturacablog_id;
    }

    public void setFacturacablog_id(int facturacablog_id) {
        this.facturacablog_id = facturacablog_id;
    }

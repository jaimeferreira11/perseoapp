 ...
 */
public class PedidosRealizadosAnuladosFragment extends Fragment {

    private RecyclerView tasks;

    SwipeRefreshLayout refresh;

    public PedidosRealizadosAnuladosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_pedidos_realizados_anulados, container, false);

        tasks = (RecyclerView) view.findViewById(R.id.rvPA);
        refresh = (SwipeRefreshLayout) view.findViewById(R.id.paRefresh);
        ...
        refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                inicializarAdaptadorRV(crearAdaptador((ArrayList<FacturaCab>) cf.getAnulados(), getResources().getString(R.string.anulados)));
